...
export class Dashboard1Component implements OnInit {
  ...
  infoCabang(){
      swal({
          title: 'Top 5 Gerai Customer Terbanyak',
          type: 'info',
          html:
            '<table class="table table-bordered table-hover">'
            +'<tr><th>Id Gerai</th><th>Nama Gerai</th><th>Total Customer</th></tr>'
            +'<tr><td>GAC-001</td><td>Gerai Palmerah</td><td>120</td></tr>'
            +'<tr><td>GAC-008</td><td>Gerai Bogor</td><td>80</td></tr>'
            +'</table>',
  ...
  ngOnInit() {
    ...
    var vectorMap = (<any>$('#world-map')).vectorMap({
        map: 'world_mill_en',
    ...
    (<any>$('#sparkline-1')).sparkline(myvalues, {
      type: 'line',
      lineColor: '#92c1dc',
      fillColor: "#ebf4f9",
      height: '50',
    ...
    (<any>$('#sparkline-2')).sparkline(myvalues, {
      type: 'line',
      lineColor: '#92c1dc',
      fillColor: "#ebf4f9",
      height: '50',
    ...
    (<any>$('#sparkline-3')).sparkline(myvalues, {
      type: 'line',
      lineColor: '#92c1dc',
      fillColor: "#ebf4f9",
      height: '50',
